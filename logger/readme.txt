...
The implementation of LoggerTarget are FileLogger, ConsoleLogger & EmailLogger, based on the property defied a log.properties file, respective bean will be injected at runtime. How-every, we can enhance it to support multiple loggers
